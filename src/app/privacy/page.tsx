    ...
    return (
        <div className={styles.main}>
            ...
            <div className={styles.main}>
                ...
                <p>Any links to third-party services do not constitute endorsements of their content. 24cast is not responsible for any content linked on domains other than this one.</p>
            </div>
            <div className={styles.main}>
            ...
            <div className={styles.main}>
                ...
                <p>24cast is based in Rhode Island. These Terms should be considered with regard to the law of Rhode Island and the United States. Any litigation or arbitration against the proprietors of 24cast should be brought in Rhode Island.</p>
            </div>
            <div className={styles.main}>
                <p><b>Intended Use</b></p>
                <p>The site is intended for individuals within the United States. 24cast does not guarantee compliance with any laws in jurisdictions outside of the United States.</p>
            </div>
        </div>
