  ...
  return (
    <Module>
      <div className={styles.welcome}>
        ...
        <p>
        The predictions below are based on our machine learning model. While our predictive accuracy is high for past elections, these predictions are based on data that is expected to change greatly before election day, so <b>these predictions will change</b>. Our &ldquo;outcome likelihood&rdquo; represents the probability of an outcome based on our current information&mdash;not a guarantee. Ultimately, the outcome of the 2024 election will depend on how the American people vote, so please <a href="https://turbovote.org/" className={styles.voteLink}>
